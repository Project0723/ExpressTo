...
import { getDatabase, ref, child, get, update } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-database.js";
...
document.getElementById('SaveUpdateBtn').addEventListener('click', function() {
    ...
    const updatedData = {
        ...
        receivername: document.getElementById('update_sname').value,
        receiverphone: document.getElementById('update_sphone').value,
        receiverunit: document.getElementById('update_sunit').value,
        receiverstreet: document.getElementById('update_sstreet').value,
        receivercity: document.getElementById('update_scity').value,
        receiverprovince: document.getElementById('update_sprovince').value,
        receiverpostal: document.getElementById('update_spostal').value,
